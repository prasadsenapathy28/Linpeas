...
from bs4 import BeautifulSoup  # Import BeautifulSoup for HTML parsing and sanitization
...
def sanitize_html(html_text):
    # Use BeautifulSoup to parse and sanitize the HTML text
...
def main():
    ...
    try:
        ...
        print(f"Error: Invalid JSON data in '{JSON_PATH}'. {json_err}")
        sys.exit(1)
    except Exception as e:
